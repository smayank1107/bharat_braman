...
<body>
    ...
    <div class="container1">
        <img src="/img/mayank7.jpg" alt="About Us Image" class="image2">
        <div class="overlay-text3">BOOK</div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/TRAVELPROJECT/book.php/">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-3">
        ...
        ?>
        <form action="/TRAVELPROJECT/book.php/" method="post">
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" name="name" class="form-control" id="name" value="<?php echo isset($name) ? $name : ''; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="desc" id="desc" cols="30" rows="10"><?php echo isset($desc) ? $desc : ''; ?></textarea>
            </div>
        ...
        if ($conn) {
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<p class="card-text">' . htmlspecialchars($row['concern']) . '</p>';
                    echo '<p class="card-text"><small class="text-muted">Submitted on ' . $row['dt'] . '</small></p>';
                    echo '</div>';
                    echo '</div>';
                }
            } else {
                echo '<div class="alert alert-info mt-3" role="alert">No reviews found.</div>';
            }
        } else {
            echo '<div class="alert alert-danger mt-3" role="alert">Failed to retrieve reviews.</div>';
        }
        ?>
    </div>
